...
func (q *Queries) MarkQuoteUpdateFailed(ctx context.Context, arg MarkQuoteUpdateFailedParams) (QuoteUpdate, error) {
	row := q.db.QueryRow(ctx, markQuoteUpdateFailed, arg.ErrorMessage, arg.ID, arg.LeaseToken)
	var i QuoteUpdate
	err := row.Scan(
		&i.ID,
		&i.CurrencyPair,
...
func (q *Queries) MarkQuoteUpdateSucceeded(ctx context.Context, arg MarkQuoteUpdateSucceededParams) (QuoteUpdate, error) {
	row := q.db.QueryRow(ctx, markQuoteUpdateSucceeded, arg.Rate, arg.ID, arg.LeaseToken)
	var i QuoteUpdate
	err := row.Scan(
		&i.ID,
		&i.CurrencyPair,
...
func (q *Queries) ScheduleQuoteUpdateRetry(ctx context.Context, arg ScheduleQuoteUpdateRetryParams) (QuoteUpdate, error) {
	row := q.db.QueryRow(ctx, scheduleQuoteUpdateRetry,
		arg.ErrorMessage,
		arg.NextAttemptAt,
		arg.ID,
		arg.LeaseToken,
